...
export const COMP_QUESTIONS: Question[] = [
  ...
  choice({
    ...
    choices: ['sam organizuje szkolny kiermasz i doprowadza akcję do końca', 'sumiennie wykonuje wszystkie zadania przydzielone przez nauczyciela', 'ma wiele pomysłów na akcje, ale żadnego nie próbuje zrealizować', 'zawsze wybiera najbezpieczniejsze rozwiązanie, by uniknąć porażki'],
    answer: 'A',
    ...
    errors: [
      ['B', 'Sumienność to zaleta, ale nie inicjatywa.', 'Przedsiębiorczość to samodzielne podejmowanie działań.'],
      ['C', 'Pomysły bez działania to jeszcze nie przedsiębiorczość.', 'Liczy się wprowadzanie pomysłów w życie.'],
      ['D', 'Przedsiębiorczość wymaga rozsądnego ryzyka.', 'Unikanie wszelkiego ryzyka to jej brak.'],
    ],
  }),
  choice({
    id: 'bk-e-2',
  ...
  choice({
    ...
    choices: ['obejmują wiedzę, umiejętności i postawy, które można rozwijać', 'to wrodzony talent, którego nie da się wyćwiczyć', 'przydają się tylko osobom zakładającym własną firmę', 'sprowadzają się do wiedzy o finansach i prawie'],
    answer: 'A',
    ...
    errors: [
      ...
      ['D', 'To tylko część — liczą się też umiejętności i postawy.', 'Kompetencje to wiedza, umiejętności i postawy.'],
    ],
  }),
  choice({
    id: 'bk-e-5',
    ...
    choices: ['szansą rynkową i źródłem innowacji', 'zagrożeniem, bo seniorzy wydają mniej', 'sprawą państwa, a nie przedsiębiorców', 'chwilową modą, którą lepiej przeczekać'],
    answer: 'A',
    ...
    errors: [
      ['B', 'To uproszczenie — seniorzy tworzą nowy, rosnący popyt.', 'Zmiana demograficzna to szansa rynkowa.'],
      ['C', 'Usługi dla seniorów to także rynek dla firm.', 'Przedsiębiorca dostrzega okazje.'],
      ['D', 'Starzenie się społeczeństwa to trwały trend.', 'Trwałe trendy tworzą szanse rynkowe.'],
    ],
  }),
  choice({
    id: 'bk-e-6',
  ...
  choice({
    ...
    choices: ['„Denerwuję się, gdy raport przychodzi po terminie, bo nie mogę przygotować prezentacji.”', '„Znowu spóźniłeś się z raportem i przez ciebie nie zdążę z prezentacją!”', '„Jesteś nieodpowiedzialny, bo raport znowu przyszedł po terminie.”', '„Wszyscy w zespole mają już dość twoich spóźnień z raportami.”'],
    answer: 'A',
    ...
    errors: [
      ['B', 'To oskarżenie „ty”, choć mówi o skutku.', 'Komunikat „ja” zaczyna się od moich uczuć, nie od zarzutu.'],
      ['C', 'To ocena osoby.', 'Komunikat „ja” opisuje uczucia i sytuację, nie cechy rozmówcy.'],
  ...
  choice({
    ...
    choices: ['regularne powtórki do matury', 'jutrzejszy wniosek o stypendium', 'odpisywanie na wiadomości w grupie', 'oglądanie przypadkowych filmików'],
    answer: 'A',
  ...
  choice({
    ...
    choices: ['rozpoznanie problemu, zebranie informacji, określenie wariantów, ocena i wybór, wdrożenie, ocena skutków', 'rozpoznanie problemu, określenie wariantów, wybór, zebranie informacji, wdrożenie, ocena skutków', 'zebranie informacji, rozpoznanie problemu, ocena i wybór, określenie wariantów, wdrożenie, ocena skutków', 'rozpoznanie problemu, zebranie informacji, określenie wariantów, wdrożenie, ocena i wybór, ocena skutków'],
    answer: 'A',
    ...
    errors: [
      ['B', 'Informacje zbiera się przed oceną wariantów, nie po wyborze.', 'Najpierw problem i informacje.'],
      ['C', 'Warianty trzeba określić, zanim się je oceni i wybierze.', 'Najpierw problem, potem warianty i ich ocena.'],
      ['D', 'Wdrożyć można dopiero wybrany wariant.', 'Wybór poprzedza wdrożenie.'],
    ],
  }),
  numeric({
    id: 'bk-s-6',
  ...
  choice({
    ...
    choices: ['nie podpisywać od razu, tylko w spokoju sprawdzić cenę i opinie', 'kupić, jeśli sprzedawca da dodatkowy rabat za decyzję jeszcze dziś', 'zapytać sąsiadów, którzy kupili, i kupić, jeśli są zadowoleni', 'kupić, żeby nie zrobić przykrości organizatorom, którzy postawili obiad'],
    answer: 'A',
    ...
    errors: [
      ['B', 'Rabat „tylko dziś” to reguła niedostępności.', 'Presja czasu to sygnał, by odroczyć decyzję.'],
      ['C', 'To wciąż społeczny dowód słuszności.', 'Sprawdź cenę i warunki niezależnie od innych.'],
      ['D', 'To działanie reguły wzajemności.', 'Poczęstunek nie zobowiązuje do zakupu.'],
    ],
  }),
];
