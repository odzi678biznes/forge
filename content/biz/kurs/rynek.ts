...
export const MARKET_QUESTIONS: Question[] = [
  ...
  choice({
    ...
    choices: [
      'przedsiębiorca łączy ziemię, pracę i kapitał w działające przedsięwzięcie i ponosi ryzyko jego niepowodzenia',
      'przedsiębiorczość jest jedynym czynnikiem produkcji, którego nie trzeba opłacać',
      'przedsiębiorczość to inaczej kapitał finansowy firmy',
      'przedsiębiorczość występuje wyłącznie w dużych korporacjach',
    ],
    answer: 'A',
  ...
  choice({
    ...
    choices: ['ilość wzrośnie, a zmiany ceny nie da się określić bez dodatkowych danych', 'cena i ilość wzrosną', 'cena spadnie, a ilość wzrośnie', 'cena wzrośnie, a zmiany ilości nie da się określić'],
    answer: 'A',
    ...
    errors: [
      ['B', 'Pominięty spadek ceny wywołany wzrostem podaży.', 'Efekty cenowe są przeciwne.'],
      ['C', 'Pominięty wzrost ceny wywołany wzrostem popytu.', 'Efekty cenowe są przeciwne.'],
  ...
  choice({
    ...
    choices: ['żaden — cena maksymalna powyżej ceny równowagi nie wiąże', 'niedobór masła', 'nadwyżka masła', 'cena wzrośnie do 9 zł'],
    answer: 'A',
    ...
    errors: [
      ['B', 'Niedobór powstaje, gdy cena maksymalna jest poniżej równowagi.', 'Tu jest powyżej.'],
      ['C', 'Nadwyżkę daje cena minimalna powyżej równowagi.', 'Cena maksymalna jej nie tworzy.'],
  ...
  choice({
    ...
    choices: [
      'uzgodnienie przez konkurujące sieci sklepów jednakowych cen wybranych produktów',
      'obniżenie cen, żeby przyciągnąć klientów konkurencji',
      'wprowadzenie programu lojalnościowego dla stałych klientów',
      'wspólna akcja charytatywna kilku firm z branży',
    ],
    answer: 'A',
  ...
  choice({
    ...
    choices: [
      'brak konkurencji pozwala firmie narzucać ceny; takie nadużycie pozycji dominującej może zbadać UOKiK',
      'to normalne działanie rynku — klienci zawsze mogą zrezygnować z usługi',
      'wzrost ceny oznacza, że rynek jest w równowadze konkurencji doskonałej',
      'sytuacji nie da się zmienić, bo monopol jest w Polsce zakazany z urzędu',
    ],
    answer: 'A',
