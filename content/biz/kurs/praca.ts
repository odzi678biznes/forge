...
export const WORK_QUESTIONS: Question[] = [
  ...
  choice({
    ...
    choices: ['osobę, która nie pracuje i nie szuka pracy, np. studenta studiów dziennych', 'osobę, która nie pracuje, ale aktywnie szuka pracy', 'osobę pracującą na część etatu', 'osobę prowadzącą własną firmę'],
    answer: 'A',
  ...
  choice({
    ...
    choices: ['do czerwca 2028 r. zdam egzamin na certyfikat księgowego i znajdę pracę w biurze rachunkowym', 'chcę kiedyś dobrze zarabiać', 'będę się lepiej uczyć', 'chcę pracować w ciekawym miejscu'],
    answer: 'A',
    ...
    steps: ['Cel A jest konkretny, mierzalny, realny, istotny i ma termin.', 'Pozostałe cele nie są mierzalne ani określone w czasie.'],
    errors: [
      ['B', 'Brak miary i terminu.', 'Cel SMART musi być mierzalny i mieć termin.'],
      ['C', 'Brak miary i terminu.', 'Cel SMART musi być mierzalny i mieć termin.'],
      ['D', 'Cel ogólnikowy.', 'Cel SMART musi być konkretny i mierzalny.'],
    ],
  }),
  choice({
    id: 'bw-c-2',
  ...
  choice({
    ...
    choices: [
      'studia z analizy danych, w trakcie wolontariat przy projektach organizacji pozarządowych i płatne praktyki od drugiego roku',
      'studia dowolnego kierunku i szukanie pracy dopiero po obronie dyplomu',
      'wysłanie tego samego CV do wszystkich firm od razu po maturze',
      'rezygnacja z nauki i czekanie na ofertę od pracodawcy',
    ],
    answer: 'A',
    ...
    errors: [
      ...
      ['C', 'Brak kwalifikacji i niedopasowane CV.', 'CV dopasowuje się do oferty.'],
      ['D', 'Postawa bierna.', 'Kariera wymaga aktywności.'],
    ],
  }),
  ...
  choice({
    ...
    choices: ['młodocianego nie wolno zatrudniać w godzinach nadliczbowych ani w porze nocnej', 'młodociany może pracować w nocy, jeśli wyrazi zgodę', 'młodociany może pracować po 12 godzin dziennie w wakacje', 'młodociany nie ma prawa do urlopu'],
    answer: 'A',
    ...
    errors: [
      ...
      ['D', 'Młodocianym przysługuje urlop.', 'Mają prawo do urlopu wypoczynkowego.'],
    ],
  }),
  choice({
    id: 'bw-f-6',
    ...
    choices: ['płatny urlop, wynagrodzenie chorobowe i ochrona przed zwolnieniem', 'wyższa kwota na fakturze', 'możliwość wystawiania faktur innym klientom', 'samodzielne decydowanie o wysokości składek ZUS'],
    answer: 'A',
  ...
  choice({
    ...
    choices: ['jest nieprawidłowa — to praca pod kierownictwem w wyznaczonym czasie, czyli stosunek pracy, a obsługa kasy nie jest dziełem', 'jest prawidłowa, bo strony mogą dowolnie nazwać umowę', 'jest prawidłowa, bo kasjerka otrzymuje wynagrodzenie', 'jest nieprawidłowa tylko wtedy, gdy kasjerka ma mniej niż 26 lat'],
    answer: 'A',
    ...
    errors: [
      ...
      ['C', 'Wynagrodzenie jest w każdej z tych umów.', 'Decyduje sposób wykonywania pracy.'],
      ['D', 'Wiek nie decyduje o rodzaju umowy.', 'Decyduje sposób wykonywania pracy.'],
    ],
  }),
  ...
  choice({
    ...
    choices: ['długotrwałe, uporczywe ośmieszanie pracownika i izolowanie go od zespołu', 'jednorazowa krytyka źle wykonanego zadania', 'polecenie wykonania pracy zgodnej z umową', 'ocena wyników pracy w corocznej rozmowie'],
    answer: 'A',
    ...
    errors: [
      ...
      ['C', 'Polecenie zgodne z umową jest prawem pracodawcy.', 'To nie mobbing.'],
  ...
  choice({
    ...
    choices: ['gromadzenie dowodów (maile, notatki z datami, świadkowie) i zgłoszenie sprawy wewnętrznie lub do Państwowej Inspekcji Pracy', 'natychmiastowe odejście z pracy bez słowa', 'publiczne oskarżenie przełożonego w mediach społecznościowych', 'ignorowanie sytuacji w nadziei, że minie'],
    answer: 'A',
    ...
    errors: [
      ['B', 'Odejście bez dowodów utrudnia dochodzenie praw.', 'Najpierw zbieraj dowody i zgłoś sprawę.'],
  ...
  choice({
    ...
    choices: ['pracownicy (brak ubezpieczenia i ochrony), uczciwi konkurenci i budżet państwa', 'wyłącznie budżet państwa', 'nikt — pracownicy dostają więcej pieniędzy do ręki', 'wyłącznie firma, która musi płacić gotówką'],
    answer: 'A',
    ...
    errors: [
      ...
      ['D', 'Firma zyskuje kosztem innych.', 'Tracą pracownicy, konkurenci i państwo.'],
    ],
  }),
  choice({
    id: 'bw-e-6',
    ...
    choices: ['szkolenia z kodeksu, kanał do anonimowego zgłaszania naruszeń i konsekwentne reagowanie także wobec kadry kierowniczej', 'wywieszenie kodeksu w recepcji', 'podpisanie kodeksu przez prezesa', 'dopisanie do kodeksu większej liczby zasad'],
    answer: 'A',
    ...
    errors: [
      ...
      ['C', 'Podpis prezesa to formalność.', 'Potrzebne są szkolenia i reakcje na naruszenia.'],
