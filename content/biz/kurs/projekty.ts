...
export const PROJ_QUESTIONS: Question[] = [
  ...
  choice({
    ...
    choices: ['zorganizowanie studniówki w lutym przyszłego roku', 'codzienna obsługa klientów w sklepie', 'comiesięczna wypłata wynagrodzeń', 'cotygodniowe sprzątanie biura'],
    answer: 'A',
  ...
  choice({
    ...
    choices: ['zebrać 3000 zł na karmę do 15 grudnia, organizując kiermasz ciast w szkole', 'pomóc zwierzętom', 'zrobić coś dobrego w grudniu', 'zebrać jak najwięcej pieniędzy'],
    answer: 'A',
    ...
    steps: ['Cel A jest konkretny, mierzalny (3000 zł), realny, istotny i ma termin.', 'Pozostałe są ogólnikowe.'],
    errors: [
      ['B', 'Brak miary i terminu.', 'SMART: konkretny, mierzalny, z terminem.'],
      ['C', 'Brak miary i konkretu.', 'SMART: konkretny, mierzalny, z terminem.'],
      ['D', 'Brak konkretnej wartości i terminu.', 'SMART: konkretny, mierzalny, z terminem.'],
    ],
  }),
  text({
    id: 'bj-b-5',
  ...
  choice({
    ...
    choices: ['wójt gminy, który zatwierdza i finansuje projekt z budżetu gminy', 'firma dostarczająca ławki', 'mieszkańcy, którzy będą korzystać z parku', 'ogrodnik sadzący drzewa'],
    answer: 'A',
    ...
    steps: ['Sponsor finansuje projekt i zatwierdza kluczowe decyzje.', 'Dostawcy, użytkownicy i wykonawcy to inni interesariusze.'],
    errors: [
      ['B', 'To dostawca.', 'Sponsor finansuje projekt.'],
      ['C', 'To użytkownicy (interesariusze).', 'Sponsor finansuje projekt.'],
      ['D', 'To wykonawca — członek zespołu.', 'Sponsor finansuje projekt.'],
    ],
  }),
  choice({
    id: 'bj-b-7',
    ...
    choices: ['wymagania są znane i stabilne, a etapy muszą następować po sobie (fundamenty przed ścianami)', 'bo klient chce co tydzień zmieniać projekt hali', 'bo nie trzeba niczego planować', 'bo podejście kaskadowe zawsze jest tańsze od zwinnego'],
    answer: 'A',
    ...
    errors: [
      ...
      ['C', 'Kaskada wymaga dokładnego planu.', 'Planowanie jest kluczowe.'],
  ...
  choice({
    ...
    choices: ['do rozbicia projektu na mniejsze pakiety prac, które da się zaplanować i przydzielić', 'do rozliczenia podatku od projektu', 'do wyboru sponsora', 'do reklamowania projektu w mediach'],
    answer: 'A',
    ...
    errors: [
      ['B', 'WBS nie dotyczy podatków.', 'To podział projektu na pakiety prac.'],
      ['C', 'WBS nie służy do wyboru sponsora.', 'To podział projektu na pakiety prac.'],
      ['D', 'WBS to narzędzie planowania.', 'To podział projektu na pakiety prac.'],
    ],
  }),
  numeric({
    id: 'bj-p-2',
  ...
  choice({
    ...
    choices: ['rozrastania się zakresu, które zagraża terminowi, budżetowi lub jakości (trójkąt ograniczeń)', 'ryzyko kursowe', 'ryzyko pogodowe', 'brak ryzyka, bo klient ma zawsze rację'],
    answer: 'A',
    ...
    errors: [
      ['B', 'Nie ma mowy o walutach.', 'Chodzi o rozrastanie się zakresu.'],
      ['C', 'Nie ma mowy o pogodzie.', 'Chodzi o rozrastanie się zakresu.'],
      ['D', 'Każda zmiana zakresu niesie ryzyko.', 'Trzeba ocenić jej wpływ.'],
    ],
  }),
  choice({
    id: 'bj-p-6',
    ...
    choices: ['skrócenie kolejnych zadań na ścieżce krytycznej (np. dodatkowe osoby, równoległa praca), po ocenie kosztów', 'skrócenie zadania, które ma 10 dni zapasu', 'zignorowanie opóźnienia', 'dopisanie nowych zadań do projektu'],
    answer: 'A',
    ...
    errors: [
      ...
      ['C', 'Opóźnienie przesunie koniec projektu.', 'Trzeba działać.'],
      ['D', 'Nowe zadania wydłużą projekt.', 'Skracać trzeba zadania krytyczne.'],
    ],
  }),
  choice({
    id: 'bj-p-7',
    ...
    choices: ['wyciągnięciu wniosków na przyszłe projekty (lessons learned)', 'rozpoczęciu realizacji projektu', 'wyborze sponsora', 'zatwierdzeniu budżetu na start'],
    answer: 'A',
    ...
    errors: [
      ['B', 'Realizacja już się zakończyła.', 'To etap zamknięcia i wniosków.'],
      ['C', 'Sponsora wybiera się na starcie.', 'To etap zamknięcia i wniosków.'],
      ['D', 'Budżet zatwierdza się przy planowaniu.', 'To etap zamknięcia i wniosków.'],
    ],
  }),
  ...
  choice({
    ...
    choices: ['od empatii — zrozumienia potrzeb użytkowników', 'od zbudowania prototypu', 'od wyboru ceny produktu', 'od kampanii reklamowej'],
    answer: 'A',
    ...
    errors: [
      ...
      ['C', 'Cena nie jest etapem design thinking.', 'Start to empatia.'],
      ['D', 'Reklama nie jest etapem design thinking.', 'Start to empatia.'],
    ],
  }),
  choice({
    id: 'bj-t-3',
    ...
    choices: ['próżniactwo społeczne; jasny podział zadań z imiennymi odpowiedzialnościami i terminami', 'efekt synergii; zwiększenie zespołu', 'burza mózgów; zakaz rozmów', 'benchmarking; porównanie z konkurencją'],
    answer: 'A',
    ...
    errors: [
      ...
      ['C', 'Burza mózgów to technika kreatywności.', 'Opisane zjawisko to próżniactwo społeczne.'],
      ['D', 'Benchmarking to porównywanie się z najlepszymi.', 'Opisane zjawisko to próżniactwo społeczne.'],
    ],
  }),
  text({
    id: 'bj-t-4',
  ...
  choice({
    ...
    choices: ['wyznaczanie pośrednich celów, świętowanie osiągniętych kamieni milowych i regularna informacja zwrotna', 'unikanie rozmów o postępach, by nikogo nie stresować', 'publiczne krytykowanie osób, które się spóźniają', 'obietnica nagrody wyłącznie po zakończeniu całego projektu'],
    answer: 'A',
