...
export const MGMT_QUESTIONS: Question[] = [
  ...
  choice({
    ...
    choices: ['planowanie, organizowanie, przewodzenie, kontrolowanie', 'produkcja, sprzedaż, księgowość, reklama', 'planowanie, organizowanie, finansowanie, sprzedawanie', 'zakup, magazynowanie, transport, sprzedaż'],
    answer: 'A',
    ...
    steps: ['Funkcje zarządzania: planowanie, organizowanie, przewodzenie (motywowanie), kontrolowanie.', 'Pozostałe zestawy to działy firmy, obszary działalności lub etapy procesów.'],
    errors: [
      ['B', 'To obszary działalności firmy.', 'Funkcje zarządzania to planowanie, organizowanie, przewodzenie, kontrolowanie.'],
      ['C', 'Finansowanie i sprzedaż to obszary działalności, nie funkcje zarządzania.', 'Funkcje zarządzania to planowanie, organizowanie, przewodzenie, kontrolowanie.'],
  ...
  choice({
    ...
    choices: ['publiczne uznanie i powierzenie ważnego projektu', 'premia kwartalna za wyniki zespołu', 'samochód służbowy do użytku prywatnego', 'dofinansowanie karnetu na siłownię'],
    answer: 'A',
  ...
  choice({
    ...
    choices: ['uznanie, odpowiedzialność i możliwość rozwoju', 'wysokość pensji, premie i warunki pracy', 'czyste biuro, parking i dobry sprzęt', 'jasny regulamin i stabilne zatrudnienie'],
    answer: 'A',
    ...
    errors: [
      ...
      ['D', 'Zasady i stabilność to czynniki higieny.', 'Zaangażowanie budują motywatory.'],
    ],
  }),
  choice({
    id: 'bz-h-4',
    ...
    choices: ['opinie od przełożonego, współpracowników, podwładnych i klientów', 'ocena wyłącznie przez przełożonego raz w roku', 'samoocena pracownika w ankiecie z 360 pytaniami', 'automatyczna ocena na podstawie czasu pracy w systemie'],
    answer: 'A',
    ...
    errors: [
      ...
      ['D', 'Czas pracy to nie ocena kompetencji.', '360 stopni to wiele źródeł opinii.'],
    ],
  }),
  choice({
    id: 'bz-h-5',
    ...
    choices: ['potrzeba bezpieczeństwa, np. stabilnego zatrudnienia', 'potrzeba samorealizacji, np. rozwijania talentów', 'żadna — każda potrzeba motywuje niezależnie od innych', 'żadna — samorealizacja jest najniżej w piramidzie'],
    answer: 'A',
    ...
    errors: [
      ...
      ['C', 'U Maslowa potrzeby są uporządkowane hierarchicznie.', 'Niższe zwykle muszą być zaspokojone wcześniej.'],
      ['D', 'Samorealizacja jest na szczycie piramidy.', 'Niższy poziom to np. bezpieczeństwo.'],
    ],
  }),
  choice({
    id: 'bz-h-6',
    ...
    choices: ['ścieżki rozwoju, rotacja projektów i szkolenia', 'kolejna podwyżka o 5% dla całego zespołu', 'zakaz pracy dla konkurencji wpisany do umów', 'więcej benefitów, np. owocowe czwartki i karnety'],
    answer: 'A',
    ...
    errors: [
      ...
      ['C', 'Zakaz konkurencji nie usuwa przyczyny odejść.', 'Trzeba odpowiedzieć na brak rozwoju.'],
      ['D', 'Benefity to czynniki higieny — nie dają rozwoju.', 'Trzeba odpowiedzieć na brak rozwoju.'],
    ],
  }),
  ...
  choice({
    ...
    choices: ['produkt, cena, dystrybucja (miejsce), promocja', 'produkt, cena, personel, profit', 'popyt, podaż, prognoza, produkcja', 'produkt, cena, promocja, planowanie'],
    answer: 'A',
    ...
    errors: [
      ['B', 'Personel i profit nie należą do klasycznego 4P.', 'Poprawnie: produkt, cena, dystrybucja, promocja.'],
      ['C', 'To pojęcia rynkowe.', 'Poprawnie: produkt, cena, dystrybucja, promocja.'],
      ['D', 'Planowanie to funkcja zarządzania, nie element 4P.', 'Brakuje dystrybucji (miejsca).'],
    ],
  }),
  numeric({
    id: 'bz-o-2',
  ...
  choice({
    ...
    choices: ['ocena ryzyka, osłony maszyn, środki ochrony i szkolenia', 'obniżenie pensji pracownikom, którzy ulegli wypadkom', 'przeniesienie odpowiedzialności za bezpieczeństwo na pracowników', 'zwiększenie tempa produkcji, by nadrobić przestoje'],
    answer: 'A',
  ...
  choice({
    ...
    choices: ['wręczający i przyjmujący korzyść', 'tylko urzędnik, bo to on złamał obowiązki', 'tylko przedstawiciel firmy, bo to on zaproponował', 'nikt, jeśli prezent jest niewielki'],
    answer: 'A',
  ...
  choice({
    ...
    choices: ['turysta, który raz przejechał przez to miasto', 'pracownicy fabryki i ich związek zawodowy', 'mieszkańcy domów sąsiadujących z fabryką', 'dostawcy drewna z pobliskich tartaków'],
    answer: 'A',
  ...
  choice({
    ...
    choices: ['to działanie wizerunkowe, a nie społeczna odpowiedzialność', 'to CSR, bo firma pomaga potrzebującym', 'to w porządku, bo dobroczynność równoważy opóźnienia', 'pracownicy powinni wspierać akcję zamiast domagać się pensji'],
    answer: 'A',
    ...
    errors: [
      ...
      ['C', 'Dobroczynność nie zwalnia z obowiązków wobec pracowników.', 'CSR zaczyna się od uczciwego traktowania pracowników.'],
  ...
  choice({
    ...
    choices: ['mniejsze ryzyko skandalu i lepsza reputacja w długim okresie', 'natychmiastowe obniżenie kosztów zakupu materiałów', 'prawo do ulgi podatkowej za każdego takiego dostawcę', 'brak potrzeby kontrolowania jakości dostaw'],
    answer: 'A',
    ...
    errors: [
      ...
      ['C', 'Nie ma takiej ulgi.', 'Korzyścią jest mniejsze ryzyko i reputacja.'],
