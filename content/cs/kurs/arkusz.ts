...
export const SHEET_QUESTIONS: Question[] = [
  ...
  choice({
    ...
    choices: [
      'do grupowania danych według kategorii i podsumowania ich (suma, liczba, średnia)',
      'do zamiany wierszy z kolumnami bez obliczeń',
      'do sortowania jednej kolumny',
      'do ochrony arkusza hasłem',
    ],
    answer: 'A',
    ...
    errors: [
      ...
      ['C', 'Sortowanie nie tworzy podsumowań.', 'Tabela przestawna grupuje i podsumowuje.'],
